...
[W3C](https://validator.w3.org/) was used to validate the HTML on CSS.
...
I used Lighthouse thats withoin Chrome Developer Tools to test the websites performance, accessibility, best practices and SEO.
...
| :--- | :--- |
| I want to immediately understand the purpose of the website. | The greating message and the name in the URL tells the user that it is the developers personal website. |
| I want to be able to navigate the website effortlessly uppon first visit. | Easy navigation provided by a single continuos page with a menu that is positioned to bi visible at all times. |
...
|Typing animation in the greating message | Reloaded page | Give the ilusion of typing uppon reload | The word 'website' appears to be typed in uppon loading | Pass |
...
| The 'X' closing button | Clicked the button | hide the figcaption | The figcaption disappears from the view | Pass |
| Arrow animation | Observed | Goes left and right on a loop | Arrow moves left and right as if its pointing to an icon | Pass |
